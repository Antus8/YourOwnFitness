	...
	<nav>
	 <ul>
		...
		<div id="Registration-Form">
			<div class="container">
					<p id="pre">Descrizione di cosa è l'IMC (BMI)<p>
					<hr>
					...
					<form action="#">
						<div class="user-details">
							...
							<div class="input-box">
								<span class="details">Altezza</span>
								<input type="text" name="height" value=" " placeholder="Inserisci la tua altezza" required>
							...
							<div class="input-box">
								...
								<input type="text" name="weight" value=" " placeholder="Inserisci il tuo peso" required>
						...
						<div class="button">
							<input type="submit" name="calculate" value="Calcola il tuo IMC!">
						</div>
					</form>
			</div>
		</div>
